...
getTCGACopyNumberData = function(cancer.type){
  ...
  # Upstream path
  tcga.cn.path.up = file.path("/home/data/public_datasets/TCGA/Copy_Number_Variation/", ctype)
...
getTCGAExpressionData = function(cancer.type, annotation.file){
  ...
  # Upstream path
  tcga.exp.path.up = file.path("/home/data/public_datasets/TCGA/Gene_Expression_Quantification/", ctype)
...
getTCGAMutationData = function(cancer.type){
  ...
  # Upstream path
  tcga.mut.path.up = file.path("/home/data/public_datasets/TCGA/Masked_Somatic_Mutation")
...
getClinData = function(cancer.type){
  ...
  path.to.clin = "/home/data/public_datasets/TCGA/Clinical_Data"
...
getClinEndpointData = function(cancer.type){
  ...
  clin.endpoints = read.csv("/home/data/public_datasets/TCGA/TCGA_CDR_clinical_endpoints.csv") 
