...
# Output dir 
out.dir.data = file.path("/lustre/projects/landstrom_core/data/rdata/manuscript_work/revisions/cellcycle", cancer.type)
...
dir.res.root = file.path("/lustre/projects/landstrom_core/results/prognostic_model_development_revised_cell_cycle/cellcycle/", cancer.type)
...
onco.genes.df = read.csv("/lustre/projects/landstrom_core/data/QuickGO_cell_cycle_condenced.csv", sep = "\t")
...
gene.list  = unique(c(onco.genes.df[,1], customer.genes))
