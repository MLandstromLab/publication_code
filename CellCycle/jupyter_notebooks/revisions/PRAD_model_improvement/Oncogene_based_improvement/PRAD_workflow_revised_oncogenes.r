...
# Output dir 
out.dir.data = file.path("/lustre/projects/landstrom_core/data/rdata/manuscript_work/revisions/oncogenes", cancer.type)
...
dir.res.root = file.path("/lustre/projects/landstrom_core/results/prognostic_model_development_revised_cell_cycle/oncogenes/", cancer.type)
...
onco.genes.df = read.csv("/lustre/projects/landstrom_core/data/cancerGeneList_oncokb.tsv", sep = "\t")
...
gene.list  = unique(c(onco.genes.df[,2], customer.genes))
