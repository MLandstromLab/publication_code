...
# Path to rdata
rdata.path = "/lustre/projects/landstrom_core/data/rdata/manuscript_work/revisions/oncogenes/PRAD/"

# Read in preprocessed data 
tcga.dataset.merged = readRDS(file.path(rdata.path, "tcga.dataset_merged.rds"))

variables.selected.filtered.ls = readRDS("/lustre/projects/landstrom_core/results/prognostic_model_development_revised_cell_cycle/oncogenes/PRAD/significant.features.ls")
