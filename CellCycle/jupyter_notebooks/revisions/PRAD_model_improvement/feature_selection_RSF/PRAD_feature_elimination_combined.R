...
# Path to rdata
rdata.path = "/lustre/projects/landstrom_core/data/rdata/manuscript_work/revisions/combined_list/PRAD/"

# Read in preprocessed data 
tcga.dataset.merged = readRDS(file.path(rdata.path, "tcga.dataset_merged.rds"))

variables.selected.filtered.ls = readRDS("/lustre/projects/landstrom_core/results/prognostic_model_development_revised_cell_cycle/combined/PRAD/significant.features.ls")
...
saveRDS(feature.elim.pfi, file.path(rdata.path, "Feature_elimination_res_PFI_oncogenes.rds"))
